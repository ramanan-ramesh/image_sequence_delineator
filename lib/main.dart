...
import 'package:image_sequence_delineator/image_sequence_delineator.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      title: 'Image Sequence Delineator Demo',
      theme: ThemeData(primarySwatch: Colors.blue),
      home: MyHomePage(title: 'Image Sequence Delineator Demo'),
    );
  }
}
...
class _MyHomePageState extends State<MyHomePage> {
  ImageSequenceDelineatorState get imageSequenceAnimator =>
      isOnline ? onlineImageSequenceAnimator : offlineImageSequenceAnimator;
  ImageSequenceDelineatorState offlineImageSequenceAnimator;
  ImageSequenceDelineatorState onlineImageSequenceAnimator;
  ...
  void onOfflinePlaying(ImageSequenceDelineatorState _imageSequenceAnimator) {
    setState(() {});
  }

  void onOnlineReadyToPlay(
      ImageSequenceDelineatorState _imageSequenceAnimator) {
    onlineImageSequenceAnimator = _imageSequenceAnimator;
  }

  void onOnlinePlaying(ImageSequenceDelineatorState _imageSequenceAnimator) {
    setState(() {});
  }
