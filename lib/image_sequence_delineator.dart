library image_sequence_delineator;
...
typedef ImageSequenceProcessCallback = void Function(
    ImageSequenceDelineatorState _imageSequenceAnimator);

class ImageSequenceDelineator extends StatefulWidget {
  ...
  ///Set this value to true if you want the [ImageSequenceDelineator] to wait until the entire image sequence is cached. Otherwise, the [ImageSequenceDelineator]
  ...
  ///Use this function to display a widget until the [ImageSequenceDelineator] is ready to be played. This value is only used if [isOnline] is set to true.
  final CacheProgressIndicatorBuilder cacheProgressIndicatorBuilder;

  ///The callback for when the [ImageSequenceDelineator] is ready to start playing.
  final ImageSequenceProcessCallback onReadyToPlay;

  ///The callback for when the [ImageSequenceDelineator] starts playing.
  final ImageSequenceProcessCallback onStartPlaying;

  ///The callback for when the [ImageSequenceDelineator] is playing. This callback is continuously through the entire process.
  final ImageSequenceProcessCallback onPlaying;

  ///The callback for when the [ImageSequenceDelineator] finishes playing.
  final ImageSequenceProcessCallback onFinishPlaying;

  const ImageSequenceDelineator(
    this.folderName,
    this.fileName,
    this.suffixStart,
    this.suffixCount,
  ...
  @override
  ImageSequenceDelineatorState createState() {
    return ImageSequenceDelineatorState(
      folderName,
      fileName,
      fileFormat,
      isLooping,
...
class ImageSequenceDelineatorState extends State<ImageSequenceDelineator>
  ...
  ///Use this value to check if this [ImageSequenceDelineator] is currently looping.
  bool get isLooping => _isLooping;
  bool _isLooping;

  ///Use this value to check if this [ImageSequenceDelineator] is currently boomeranging.
  bool get isBoomerang => _isBoomerang;
  bool _isBoomerang;

  ///Use this value to check the current color of this [ImageSequenceDelineator].
  Color color;
  ...
  ///Use this function to set the value for [ImageSequenceDelineatorState.isLooping] at runtime.
  ...
  ///Use this function to set the value for [ImageSequenceDelineatorState.isBoomerang] at runtime.
  ...
  ///Use this function to set the value for [ImageSequenceDelineatorState.color] at runtime.
  ...
  ///Use this function to play this [ImageSequenceDelineator].
  ...
  ///Use this function to rewind this [ImageSequenceDelineator].
  ...
  ///Use this function to pause this [ImageSequenceDelineator].
  void pause() {
    if (!_isReadyToPlay) return;
  ...
  ///Use this function to restart this [ImageSequenceDelineator].
  void restart() {
    if (!_isReadyToPlay) return;
  ...
  ///Use this function to stop this [ImageSequenceDelineator].
  void stop() {
    if (!_isReadyToPlay) return;
